...
describe("Diamond Test", async () => {
  ...
  describe("Facet Test", () => {
    it("should add test1 functions", async () => {
      ...
      const selectors = getSelectors(facet).remove([
      ...
      assert.deepEqual(
        selectors,
        await getFacetFunctionSelectors(facet.address)
      );
    });
    ...
    it("should replace supportsInterface function", async () => {
      ...
      assert.deepEqual(
        getSelectors(facet),
        await getFacetFunctionSelectors(addr)
      );
    });
    ...
    it("should remove some test2 functions", async () => {
      ...
      assert.deepEqual(
        getSelectors(facet).get(keepFuncs),
        await getFacetFunctionSelectors(addresses[4])
      );
    });
    ...
    it("should remove some test1 functions", async () => {
      ...
      assert.deepEqual(
        getSelectors(facet).get(keepFuncs),
        await getFacetFunctionSelectors(addresses[3])
      );
    });
